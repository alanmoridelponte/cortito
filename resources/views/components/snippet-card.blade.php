...
<div class="group relative flex flex-col overflow-hidden rounded-xl border border-border-warm bg-warm-white shadow-sm transition-all duration-200 hover:border-graphite-light/30 hover:shadow-md {{ $config['accent'] }}"
    ...
    {{-- Footer --}}
    <div class="flex items-center border-t border-border-light bg-cream/40 px-5 py-3 sm:px-6 sm:py-3.5">
        <div class="flex items-center grow justify-between gap-3 sm:gap-4 text-xs text-graphite-light">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('snippets.edit', $snippet->alias) }}"
                   ...
                   class="inline-flex h-7 w-7 items-center justify-center rounded-md transition-colors hover:bg-celeste-light hover:text-celeste cursor-pointer"
                   title="Editar">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <button
                    ...
                    class="inline-flex h-7 w-7 items-center justify-center rounded-md transition-colors hover:bg-danger-light hover:text-danger cursor-pointer"
                    title="Eliminar">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            @endif
            <button type="button"
                    class="inline-flex items-center gap-1.5 rounded-lg border border-border-warm bg-cream-dark/70 px-3 py-1.5 font-medium transition-all text-xs duration-150 btn-press h-8 cursor-pointer"
